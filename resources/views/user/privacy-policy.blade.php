...
@section('title', 'Privacy Policy | Centuera')
@section('content')
<!-- BEGIN: Content-->
        ...
        <div class="main-max-width">
            <div class="page-title-content">
                ...
                <ul class="page-breadcrumb align-items-center list-unstyle">
                    ...
                    <li class="primery-link">Privacy Policy</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="blog-section ptb-100">
    <div class="container">
        <h3 class="tab-heading">Privacy Policy</h3>
        <hr class="tab-hr">
        <h4>Purpose</h4>
        <p>Centuera (“Centuera,” “we,” “us,” or “our”) is committed to protecting your privacy, we
        ...
        <h4>Our Website, Including but Not Limited to:</h4>
        <ul>
            <li>Website: www.centuera.com</li>
        </ul>
        <p>This Privacy Policy regulates how you use our website and its associated items, so please
            read it carefully. Please do not use our services if you disagree with this privacy
            statement.</p>

        <h4>Notice to End Users</h4>
        <p>An administrator may occasionally register an account and submit data—including personal
            ...
            not included in any of the categories; no third parties will get this information.</p>

        <h4>International Transfer</h4>
        <p>We may keep and handle the personal data we gather in your area and any other nation
            ...
            States, India, Singapore, and Japan along with its data sub-processors.</p>
        <p>Employees working in the aforementioned nations may also process the data we have; these
            ...
            countries by providing your data and/or using our services.</p>

        <h5>Use of your Personal Information and Other Data</h5>
        <p>The use of your personal information by the Company is governed by this Privacy Policy.
            ...
            website and to better understand our visitors.</p>

        <h4>Personal Identifiable Information</h4>
        <p>In the following circumstances, we could get the following personal data from you:</p>
        <ul>
            <li>On our website, when you visit one of our contact forms, when you chat or call us,
                when you purchase one of our courses, or when you register, you freely supply the
                following information:
                <ul>
                    <li>Contact details include name, phone number, email address, mailing address,
                        and IP.</li>
                    <li>Details about your organization, like your name, size, and kind of
                        operation.</li>
                    <li>Your account details, which might include the password and billing data.
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>When utilizing our mobile applications, support system, learning management system
                (*.lms.Centuera.com), or answering our surveys:
                <ul>
                    <li>Contact details include name, phone number, IP address, mailing address,
                        email address, and location.</li>
                    <li>Unique identifiers, such a password or username.</li>
                </ul>
            </li>
            <li>When use our blogs or community website
                <ul>
                    <li>Please refer to our section on Public Forums</li>
                </ul>
            </li>
        </ul>
        <p>However, users are free to browse our site anonymously. Users' personal identification
            ...
            it impossible for them to participate in some site-related activities.</p>

        <h4>Non-Personal Identifiable Data:</h4>
        <p>In our logs, we record some non-identifiable data. Among the information in the logs is
        </p>
        <ul>
            <li>Device type</li>
            <li>Browser type</li>
        ...
        <h4>Use</h4>
        <p>When you use the Service(s), we may utilize the personal information we collect via
            email, chat boxes, mobile devices, and websites to:</p>
        <ul>
            <li>Offer you the service or services.</li>
            <li>Communicate with you via the Service(s).</li>
            <li>Evaluate your company's demands in order to identify or recommend appropriate items.
            </li>
            <li>Provide the product or service details you requested.</li>
            <li>Address inquiries from clients.</li>
            <li>Take control of your account.</li>
            <li>Deliver marketing and promotional materials to you.</li>
            <li>When you use our Service(s), arrange for transactions between you and other users.
            </li>
            <li>Conduct aggregate statistical studies of user behavior and attributes to gauge
                interest in and usage of the site's various sections.</li>
        </ul>
        <p>By accepting this Privacy Policy, you explicitly grant us permission to use your personal
            ...
            you have registered for DND, DNC, or NCPR services.</p>
        <p>We shall only use personal information you give us about your contacts for the purposes
            for which you submit it.</p>

        <h4>Share</h4>
        <p>We will share information, including personal information, with your company or an
            ...
            also release your personal information to any other third party.</p>

        <h4>Data from Third Parties</h4>
        <p>Additionally, we get data from outside sources. We safeguard information that we acquire
            ...
            these outside sources have changed, but they have comprised:</p>
        <ul>
            <li>Data brokers, from whom we get demographic information to enhance the information
                we gather.</li>
            <li>Social networks, if you give them permission to access your data on one or more of
                these networks, as well as to make your data publicly available on them.</li>
            <li>An organization that uses our services that you work for.</li>
            <li>Current or former students who take part in our referral scheme</li>
            <li>Service providers who assist us in locating you based on your IP address so that
                we may tailor specific items to your area.</li>
            <li>Partners with whom we collaborate on marketing initiatives or provide co-branded
                services, and</li>
            <li>• Sources that are open to the public, such publicly accessible government databases
                or other material in the public domain.</li>
        </ul>
        <p>We could also get Personal Information about you via fax, phone, or postal mail from
            other sources. To enhance the goods and services we offer, we can combine this
            information with the data we have previously obtained from you via the Site.</p>

        <h4>Rights to access, correction and deletion of Personal Information</h4>
        <p>Regarding your personal information, you have specific rights. You have the right to seek
        ...
        <ul>
            <li>If you independently registered for our Services, you can contact us or log into
                your account to see, amend, or export the Personal Information that is part of your
                online account at any time.</li>
            <li>If you are using an account that has been provided by the organization (your
                company or an approved training partner), please read the Notice to End Users
                section.</li>
        </ul>

        <h4>Right of Data Subject to File a Complaint</h4>
        <p>Users in the United Kingdom ("UK") and the European Economic Area ("EEA") You have the
        ...
        <h5>Users in Singapore</h5>
        <p>If you live in Singapore and have a complaint, you may file it with the PDPC office. The
            ...
            Protection Concern.</p>

        <h4>Users in California</h4>
        <p>You can submit a consumer complaint with the Office of the Attorney General if you think
        ...
        <h4>Users Other than US</h4>
        <p>We must move and process your data in the United States in order to offer you the
        ...
        <p>Cookies and other tracking technologies (such as web beacons, device identifiers, and
            ...
            across various Services and devices. The kinds of cookies we employ consist of:</p>
        <ul>
            <li>
                <h5>Essential Cookies:</h5> The fundamental features provided by the Site and
                Service(s)
            ...
            <li>
                <h5>Insight Cookies:</h5> They help us improve your user experience by recording the
                activities that users take part in inside the Service(s).
            </li>
            <li>
                <h5>Marketing Cookies:</h5> You can choose to have your computer warn you each time
        ...
        <p>You have the option to disable all cookies or to have your computer notify you each time
            ...
            might not work correctly if you disable cookies.</p>

        <h4>Advertisement</h4>
        <p>To control our advertising on other websites, we collaborate with outside companies. In
            ...
            from receiving advertisements. Generic advertisements will still be sent to you.</p>

        <h4>Analytics & Web-beacons</h4>
        <p>For analytics, we make use of third-party technologies. Our analytics provider will get
            ...
            both individually and together.</p>

        <h4>Do Not Track</h4>
        <p>Currently, a number of browsers, such as Internet Explorer, Firefox, and Safari, have a
        ...
        <p>Links to external websites that are not under our ownership or control can be found on
        ...
        <h4>Public Forums</h4>
        <p>On the Company's websites, we may offer message boards, blogs, or community threads. Any
        ...
        <h4>Features for Social Media & Single Sign-On</h4>
        <p>Social media elements on our websites include interactive mini-programs, the Facebook
            ...
            yourself, including your email address and name.</p>

        <h4>Communications from the Websites</h4>
        <p>Your email address could be used by us to send you marketing messages and/or newsletters.
            ...
            remove your account if you would like not to receive them.</p>

        <h4>Information Security</h4>
        <p>Industry-standard security measures are in place on our websites and service(s) to guard
        ...
        <ul>
            <li>We regularly check our website for security flaws and known vulnerabilities to
                ensure the safest possible experience for you when visiting us.</li>
            <li>We regularly scan for malware.</li>
            <li>Your personal information is kept private behind guarded networks and is only
                ...
                Layer (SSL) technology encrypts any credit and sensitive data you submit.</li>
            <li>No money transaction is processed or kept on our systems; instead, it is handled by
                secure gateway providers.</li>
        </ul>

        <h4>Testimonials</h4>
        <p>We publish client endorsements, remarks, and reviews on our websites, some of which could
        ...
        <p>We don't intentionally gather any personal data from kids less than eighteen. Please do
        ...
        <h4>Amendments</h4>
        <p>We reserve the right to make changes to this privacy statement at any time. When we do,
            ...
            version of this Policy, you may opt to stop using the Websites or Service(s).</p>
    </div>
</div>
</div>
<!-- Blog Section Start -->
