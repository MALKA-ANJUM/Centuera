            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">@lang('Testimonial')</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            ...
                            @endif
                                <div class="card-header border-bottom">
                                    <a href="{{ route('admin.testimonial.form') }}" class="btn btn-primary" tabindex="0"
                                    ...
                                    <form action="" method="GET" class="d-flex ms-3">
                                        ...
                                        <a href="{{ route('admin.testimonial.list') }}" class="btn btn-primary ms-1"><i
