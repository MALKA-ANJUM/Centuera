 ...
 <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{-- @can('admin.add-permission-form')
            <li class="@if ((request()->is('admin/add-permission-form'))) active @endif nav-item">
                <a class="d-flex align-items-center" href="{{ route('admin.add-permission-form') }}">
                    <i data-feather="home"></i>
                    <span class="menu-title text-truncate font-size-12px" data-i18n="Dashboards">@lang('Add Permission')</span>
                </a>
            </li>
            @endcan --}}
            ...
            <li class="@if (request()->is('admin/blog-list') || request()->is('admin/blog-form') || request()->is('admin/blog/edit*')) active @endif nav-item"><a class="d-flex align-items-center" href="{{ route('admin.blog.list') }}"><i data-feather="book"></i><span class="menu-title text-truncate font-size-12px" data-i18n="Dashboards">@lang('Blog')</span></a></li>
            <li class="@if ( (request()->is('admin/testimonial-list')) || (request()->is('admin/testimonial-form')) || (request()->is('admin/testimonial/edit*'))) active  @endif nav-item"><a class="d-flex align-items-center" href="{{ route('admin.testimonial.list') }}"><i data-feather="user"></i><span class="menu-title text-truncate font-size-12px" data-i18n="Dashboards">@lang('Testimonial')</span></a></li>
             ...
             <li class="@if (request()->is('admin/banner*')) active @endif nav-item"><a class="d-flex align-items-center" href="{{ route('admin.banner.index') }}"><i class="fa fa-image"></i><span class="menu-title text-truncate font-size-12px" data-i18n="Dashboards">Banner</span></a></li>
