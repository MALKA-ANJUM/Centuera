                ...
                <form action="{{ route('admin.course.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row"> <!-- Start row -->
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <textarea name="benefits" id="editor6" class="form-control" rows="2">{{ old('benefits') }}</textarea>
                                        @error('benefits')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <h5 class="mb-2">@lang('Course Curriculum')</h5>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <h5 class="mb-2">@lang('Courses Key Features')</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="mb-2">@lang('Skills Covered')</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="mb-2">@lang('PMP Exam and Certification')</h5>
                                    <div id="certification-container" class="flex-grow-1">
                                        <div class="border rounded p-2 mb-2 certification-group">
                                            ...
                                            @error('certifications.0.title')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                            <textarea name="certifications[0][description]" class="form-control" rows="3" placeholder="Description">{{ old('certifications.0.description') }}</textarea>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="mb-2">@lang('Trusted Partners')</h5>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <h5 class="mb-2">@lang('Why Choose Our Online PMP Bootcamp?')</h5>
                                    <div id="video-container">
                                        <div class="video-item mb-3 border p-2 rounded">
                                            ...
                                            <div class="mb-2">
                                                <label class="form-label">@lang('Description')</label>
                                                <textarea name="videos[0][description]" class="form-control" rows="2" placeholder="Enter description">{{ old('videos.0.description') }}</textarea>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <h5 class="mb-2">@lang('Frequently Asked Questions')</h5>
                                    <div id="faq-container">
                                        <div class="faq-item mb-3 border p-2 rounded">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <textarea name="faqs[0][description]" class="form-control" rows="2" placeholder="Enter answer">{{ old('faqs.0.description') }}</textarea>
                                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#add-certification', function() {
                ...
                <div class="border rounded p-2 mb-2 certification-group">
                    ...
                    <textarea name="certifications[${certIndex}][description]" class="form-control" rows="3" placeholder="Description">{{ old('certifications.${certIndex}.description') }}</textarea>
            ...
            $('#add-video').click(function() {
                ...
                <div class="video-item mb-3 border p-2 rounded">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="videos[${videoIndex}][description]" class="form-control" rows="2" placeholder="Enter description"></textarea>
                    </div>
            ...
            $('#add-faq').click(function() {
                ...
                <div class="faq-item mb-3 border p-2 rounded">
                    ...
                    <div class="mb-2">
                        <label class="form-label">@lang('Answer')</label>
                        <textarea name="faqs[${faqIndex}][description]" class="form-control" rows="2" placeholder="Enter answer"></textarea>
                    </div>
